...
function HeroSnapshotPlaceholder() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[710px]">
      ...
      <motion.div
        className="absolute -right-3 top-28 hidden rounded-[1.2rem] border border-rose-400/20 bg-black/50 px-4 py-3 shadow-[0_0_50px_rgba(244,63,94,0.12)] backdrop-blur-xl xl:block"
        animate={{ y: [0, 10, 0] }}
      ...
      >
        ...
        <div className="mt-1 text-sm font-medium text-rose-200">
          Weak items flagged early
        </div>
      </motion.div>

      <div className="relative rounded-[2.2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-4 shadow-[0_30px_100px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
        ...
        <div className="relative rounded-[1.8rem] border border-white/10 bg-[#091018] p-4">
          ...
          <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#070b12] p-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                {recentCards.map((card) => (
                  ...
                  >
                    <img src={card.image} alt={card.title} className="h-20 w-full object-cover" />
                    <div className="p-2">
            ...
            <div className="relative flex items-end justify-center">
              ...
              <div className="relative z-10 w-full max-w-[220px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#06090f] p-3 shadow-[0_30px_70px_rgba(0,0,0,0.35)]">
                <div className="mb-3 flex items-center justify-between">
                  <div>
