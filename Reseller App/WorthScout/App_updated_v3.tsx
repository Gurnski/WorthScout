        ...
        <div className="relative rounded-[1.8rem] border border-white/10 bg-[#091018] p-3 sm:p-4">
          ...
          <div className="grid gap-3 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="relative flex items-end justify-center">
              <motion.div
                className="absolute -top-5 right-2 hidden w-[150px] rounded-[1.15rem] border border-rose-400/20 bg-black/45 p-3 shadow-[0_0_45px_rgba(244,63,94,0.10)] backdrop-blur-xl lg:block"
                animate={{ y: [0, 8, 0] }}
